...
if (!CLOUDFLARE_ACCOUNT_ID || !CLOUDFLARE_ACCESS_KEY_ID || !CLOUDFLARE_SECRET_ACCESS_KEY || !CLOUDFLARE_BUCKET_NAME || !CLOUDFLARE_PUBLIC_R2_URL) {
  console.error('Cloudflare R2 env variables are not fully set for uploadImage API');
}
