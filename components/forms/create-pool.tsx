...
const cpmmPoolSchema = z.object({
  mintAAddress: z.string().min(32, "Invalid mint address").max(44, "Invalid mint address"),
  mintBAddress: z.string().min(32, "Invalid mint address").max(44, "Invalid mint address"),
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-secondary/10 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl relative">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-green-600 mb-4">Pool Created Successfully!</h1>
            <p className="text-lg text-muted-foreground">Your {creationResult.type.toUpperCase()} liquidity pool has been created</p>
          </div>

          <Card className="border-green-200 bg-green-50/50 dark:bg-green-950/20 dark:border-green-800">
            <CardHeader className="text-center">
              <CardTitle className="text-green-700 dark:text-green-300">Pool Details</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-6">
                <Button
                  onClick={() => window.open(getExplorerUrl(creationResult.txId), '_blank')}
                  className="flex-1"
                >
                  View on Solscan
                </Button>
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl relative">
        ...
        <article className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground/80 max-w-2xl mx-auto">
            Choose between CLMM for concentrated liquidity or CPMM for traditional constant product pools
          </p>
        </article>

        {/* Pool Type Selection */}
        <div className="mb-8">
          <Tabs value={poolType} onValueChange={(value) => setPoolType(value as PoolType)} className="w-full">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
              <Card className={`transition-all ${poolType === "clmm" ? "ring-2 ring-primary" : "opacity-60"}`}>
                <CardHeader>
                  ...
                  <CardDescription>
                    Advanced liquidity pools with concentrated positions for better capital efficiency
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className={`transition-all ${poolType === "cpmm" ? "ring-2 ring-primary" : "opacity-60"}`}>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                  ...
                  <CardDescription>
                    Traditional AMM pools with x*y=k formula for all price ranges
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="text-sm space-y-1 text-muted-foreground">
            ...
            <TabsContent value="clmm" className="mt-8">
              <Card className="max-w-2xl mx-auto">
                <CardHeader>
                  ...
                  <CardDescription>
                    Set up a concentrated liquidity market maker pool with custom price ranges
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Form {...clmmForm}>
                    <form onSubmit={clmmForm.handleSubmit(handleCLMMSubmit)} className="space-y-6">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>Initial Price (Token B per Token A)</FormLabel>
                            <FormControl>
                              <Input
                                type="number"
                                step="any"
                            ...
                            <FormDescription>
                              The starting price ratio between Token B and Token A
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <Select onValueChange={(value) => field.onChange(Number(value))} defaultValue={field.value.toString()}>
                              ...
                              <SelectContent>
                                <SelectItem value="0">Standard (0.01% fee)</SelectItem>
                                <SelectItem value="1">Low Fee (0.05% fee)</SelectItem>
                                <SelectItem value="2">Medium Fee (0.25% fee)</SelectItem>
                                <SelectItem value="3">High Fee (1% fee)</SelectItem>
                              </SelectContent>
                            </Select>
                            <FormMessage />
                          </FormItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea placeholder="Pool description..." {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Input placeholder="Fund owner address..." {...field} />
                                  </FormControl>
                                  <FormDescription>
            ...
            <TabsContent value="cpmm" className="mt-8">
              <Card className="max-w-2xl mx-auto">
                <CardHeader>
                  ...
                  <CardDescription>
                    Set up a constant product market maker pool with token amounts
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Form {...cpmmForm}>
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <Select onValueChange={(value) => field.onChange(Number(value))} defaultValue={field.value.toString()}>
                              ...
                              <SelectContent>
                                <SelectItem value="0">Standard (0.25% fee)</SelectItem>
                                <SelectItem value="1">Low Fee (0.05% fee)</SelectItem>
                                <SelectItem value="2">High Fee (1% fee)</SelectItem>
                              </SelectContent>
                            </Select>
                            <FormMessage />
                          </FormItem>
        ...
        {!umi?.identity && (
          <Alert className="max-w-2xl mx-auto">
            ...
            <AlertDescription>
              Please connect your wallet to create liquidity pools. Make sure you have sufficient SOL for transaction fees.
            </AlertDescription>
          </Alert>
        )}
