...
import { type AddToCPMMPoolParams, addToCPMMPool, calculateMinimumAmounts, formatPoolAmounts } from "@/lib/liquidity/cpmm/add";
import useUmiStore, { ConnectionStatus } from "@/store/useUmiStore";
import { Network } from "@/store/useUmiStore";
import { zodResolver } from "@hookform/resolvers/zod";
import BN from "bn.js";
import { AlertCircle, ArrowDown, DollarSign, Droplets, Plus, RefreshCw, Settings2, TrendingUp } from "lucide-react";
...
const AddLiquidity = () => {
  ...
  useEffect(() => {
    ...
    calculateEstimates();
  }, [watchedValues.inputAmount, watchedValues.slippagePercent, watchedValues.baseIn]);
  ...
  const setMaxAmount = () => {
    const baseToken = watchedValues.baseIn ? watchedValues.mintA : watchedValues.mintB;
    const selectedToken = availableTokens.find(token => token.mint === baseToken);
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-secondary/10 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl relative">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-green-600 mb-4">Liquidity Added Successfully!</h1>
            <p className="text-lg text-muted-foreground">Your tokens have been added to the liquidity pool</p>
          </div>

          <Card className="border-green-200 bg-green-50/50 dark:bg-green-950/20 dark:border-green-800">
            <CardHeader className="text-center">
              <CardTitle className="text-green-700 dark:text-green-300">Transaction Details</CardTitle>
            </CardHeader>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl relative">
              ...
              <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Enter specific pool ID..." {...field} />
                        </FormControl>
                        <FormDescription>
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-background px-2 text-muted-foreground">Or select tokens</span>
                    </div>
                  </div>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="mt-2">
                            <FormControl>
                              <Input placeholder="Or enter Token A mint..." {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                    ...
                    <div>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="mt-2">
                            <FormControl>
                              <Input placeholder="Or enter Token B mint..." {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base">Base Token Input</FormLabel>
                            <FormDescription>
                              {field.value ? "Input amount is for Token A" : "Input amount is for Token B"}
                            </FormDescription>
                          </div>
                          <FormControl>
                            <Checkbox
                    ...
                    {estimatedPairAmount && (
                      <div className="p-4 bg-muted/50 rounded-lg">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm font-medium">Estimated Pair Amount</span>
                        </div>
                        <p className="text-lg font-mono">{estimatedPairAmount}</p>
                        {minimumAmounts && (
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="show-advanced-add" className="text-sm font-medium cursor-pointer flex items-center gap-2">
        ...
        {!umi?.identity && (
          <Alert className="max-w-2xl mx-auto mt-6">
            ...
            <AlertDescription>
              Please connect your wallet to add liquidity. Make sure you have sufficient tokens and SOL for transaction fees.
            </AlertDescription>
          </Alert>
        )}
      </div>
